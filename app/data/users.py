...
Provides OOP interface for user operations including creation, authentication, and data access.
"""
...
class User:
    ...
    Encapsulates user information and provides methods for database persistence.
    """
    ...
    def __init__(
        ...
        """
        Initialize a User instance with database connection and user attributes.
        ...
        Args:
            ...
            role: User role (cyber, data, it, admin)
    ...
    def save(self):
        """
        Save user to database. Creates new user record.
        ...
        try:
            # Insert user record with username, password hash, and role
            cursor.execute(
