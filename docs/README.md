...
To ensure the application runs correctly, the following setup must be completed before execution:
...
This configuration is required for the application to function properly and is intentionally excluded from version control to protect sensitive credentials.
